...
public class BloodPressureLine extends View {
    ...
    public BloodPressureLine(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        defaultWidth = DeviceInfoUtil.dp2px(getContext(), 300);
        mViewWidth = defaultWidth;
        xIntervalWidth = DeviceInfoUtil.dp2px(getContext(), (int) xIntervalWidth);
        xStartOffset = DeviceInfoUtil.dp2px(getContext(), xStartOffset);
        xEndOffset = DeviceInfoUtil.dp2px(getContext(), xEndOffset);
        yStartOffset = DeviceInfoUtil.dp2px(getContext(), (int) yStartOffset);
        yEndOffset = DeviceInfoUtil.dp2px(getContext(), (int) yEndOffset);
        lineWidth = DeviceInfoUtil.dp2px(getContext(), lineWidth);
        mLinePath = new Path();
        mLinePath2 = new Path();
