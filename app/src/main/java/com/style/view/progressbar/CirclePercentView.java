 ...
 * 百分比圆环形进度 View
 */
public class CirclePercentView extends BaseProgressBar {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStripeWidth = a.getDimensionPixelSize(R.styleable.CirclePercentView_circleProgress_stripeWidth, Utils.dp2px(context, 8));
        progress = a.getInteger(R.styleable.CirclePercentView_circleProgress_percent, progress);
        mBigColor = a.getColor(R.styleable.CirclePercentView_circleProgress_bigColor, mBigColor);
        mFinishColor = a.getColor(R.styleable.CirclePercentView_circleProgress_finishColor, mFinishColor);
        mSmallColor = a.getColor(R.styleable.CirclePercentView_circleProgress_smallColor, mSmallColor);
        mTextColor = a.getColor(R.styleable.CirclePercentView_circleProgress_textColor, mTextColor);
        mCenterTextSize = a.getDimension(R.styleable.CirclePercentView_circleProgress_centerTextSize, Utils.sp2px(context, 20));
        mRadius = a.getDimensionPixelSize(R.styleable.CirclePercentView_circleProgress_radius, Utils.dp2px(context, 50));
        mIndeterminate = a.getBoolean(R.styleable.CirclePercentView_circleProgress_indeterminate, mIndeterminate);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制文本
        if (showText) {
            setCenterText(progress + getPercentTag());
